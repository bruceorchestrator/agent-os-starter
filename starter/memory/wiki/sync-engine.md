...
- iOS Safari WebSocket reconnect bug — fixed 2026-05-02 (see `daily/2026-05-02.md`).
- High-frequency edits (>5 ops/sec) can drop ops on slow networks. Backlog item.

## Cross-links

- [[design-partner-program]] — Bluefin and Tessera are heavy sync users; their incidents drive priorities here.
