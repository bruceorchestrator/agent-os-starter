---
name: morning
description: Start of day — load context, show plan. Use when user says "morning", "good morning", "start day", "begin", or invokes `/morning`.
---
...
- `memory/STATE.md` — current priorities and blockers (or "Current Focus" if personal-wiki mode)
- `memory/learnings.md` MISTAKES section — recent corrections to avoid
...
- **Watchpoints:** open asks, deadlines this week
...
- Long summaries — the user knows their project; surface only what's fresh
